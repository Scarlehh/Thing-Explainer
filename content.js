...
function binarySearch(searchIn, searchElement) {
	'use strict';

	var minIndex = 0;
	var maxIndex = searchIn.length - 1;
	var currentIndex;
	var currentElement;

	while (minIndex <= maxIndex) {
		currentIndex = (minIndex + maxIndex) / 2 | 0;
		currentElement = searchIn[currentIndex];
